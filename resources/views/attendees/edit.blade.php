<x-app-layout>
    <div class="max-w-lg mx-auto bg-white p-10 rounded-lg shadow-md">
        <h2 class="text-3xl font-semibold mb-8 text-gray-900 text-center">Edit Attendee</h2>

        <form action="{{ route('attendees.update', $attendee->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PATCH')
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $attendee->name) }}"
